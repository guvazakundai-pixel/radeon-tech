              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-4 pt-4 border-t border-border-subtle">
                    ...
                    <Link
                      to={`/store?q=${encodeURIComponent(product.name)}`}
                      className="w-full inline-flex items-center justify-center gap-1.5 text-sm font-medium text-white bg-gradient-to-r from-accent-purple to-accent-blue hover:from-accent-purple/90 hover:to-accent-blue/90 rounded-xl px-4 py-2.5 transition-all duration-300 shadow-md shadow-accent-purple/20 no-underline"
                    >
